...
{{- define "k10.restServices" -}}auth catalog crypto dashboardbff executor jobs logging metering state {{- end -}}
{{- define "k10.services" -}}aggregatedapis config {{- end -}}
{{- define "k10.statelessServices" -}}aggregatedapis auth crypto dashboardbff executor state {{- end -}}
...
state-svc:
  state-svc:
    requests:
      ...
      memory: 30Mi
{{- end -}}
{{- define "k10.multiClusterVersion" -}}1{{- end -}}
{{- define "k10.ambassadorImageTag" -}}1.13.8{{- end -}}
{{- define "k10.kanisterToolsImageTag" -}}0.63.0{{- end -}}
{{- define "k10.dexImageTag" -}}v2.24.0{{- end -}}
{{- define "k10.rhAmbassadorImageTag" -}}1.9.1{{- end -}}
